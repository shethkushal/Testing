package com.project.spring_api.controller;
...
import com.project.spring_api.constants.URI;
...
//	}
	...
	@ApiOperation(value="Records weather of cities", notes="Fetches the weather records and puts them into the backend database")
